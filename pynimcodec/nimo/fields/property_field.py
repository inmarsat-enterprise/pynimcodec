...
class PropertyField(FieldCodec):
    """A character string sent over-the-air."""
    def __init__(self, name: str, **kwargs):
        """Instantiates a PropertyField.
    ...
    def _validate_property(self, s: str) -> str:
        #TODO
        if s is not None:
    ...
    def value(self, v: str):
        self._value = self._validate_property(v)
    ...
    def encode(self) -> str:
        ...
        #     raise ValueError(f'No value defined for PropertyField {self.name}')
    ...
    def xml(self) -> ET.Element:
        """The PropertyField XML definition."""
        return super().xml()
    
    def json(self) -> dict:
        """The PropertyField JSON definition."""
        return super().json()
